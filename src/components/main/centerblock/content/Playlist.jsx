      ...
      <div class="playlist__item">
        <div class="playlist__track track">
          <div class="track__title">
            ...
            <div class="track__title-text">
              <a class="track__title-link" href="http://">
                Non Stop <span class="track__title-span">(Remix)</span>
              </a>
            </div>
          </div>
          <div class="track__author">
      ...
      <div class="playlist__item">
        <div class="playlist__track track">
          <div class="track__title">
            ...
            <div class="track__title-text">
              <a class="track__title-link" href="http://">
                Run Run <span class="track__title-span">(feat. AR/CO)</span>
              </a>
            </div>
          </div>
          <div class="track__author">
        ...
        <div class="playlist__track track">
          <div class="track__title">
            ...
            <div class="track__title-text">
              <a class="track__title-link" href="http://">
                Eyes on Fire{" "}
                <span class="track__title-span">(Zeds Dead Remix)</span>
              </a>
            </div>
          </div>
          <div class="track__author">
        ...
        <div class="playlist__track track">
          <div class="track__title">
            ...
            <div class="track__title-text">
              <a class="track__title-link" href="http://">
                Mucho Bien{" "}
                <span class="track__title-span">(Hi Profile Remix)</span>
              </a>
            </div>
          </div>
          <div class="track__author">
      ...
      <div class="playlist__item">
        <div class="playlist__track track">
          <div class="track__title">
            ...
            <div class="track__title-text">
              <a class="track__title-link" href="http://">
                Knives n Cherries <span class="track__title-span"></span>
              </a>
            </div>
          </div>
          <div class="track__author">
      ...
      <div class="playlist__item">
        <div class="playlist__track track">
          <div class="track__title">
            ...
            <div class="track__title-text">
              <a class="track__title-link" href="http://">
                How Deep Is Your Love <span class="track__title-span"></span>
              </a>
            </div>
          </div>
          <div class="track__author">
